...
accepted_sj <- ((chain_info$proposal_used[(1 + n_burnin):(n_results - 1)] == 'split_join')
                & (chain_info$accept[(1 + n_burnin):(n_results - 1)] == 1)
                & dags_still)
...
```{r, error = TRUE}
accepted_nm <- ((chain_info$proposal_used[(1 + n_burnin):(n_results - 1)] == 'node_move')
                & (chain_info$accept[(1 + n_burnin):(n_results - 1)] == 1)
                & dags_still)
print(mean(accepted_nm))
```
